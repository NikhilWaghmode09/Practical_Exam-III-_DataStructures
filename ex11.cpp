...
class Queue    //A queue is an example of a linear data structure, or more abstractly a sequential collection.
{   struct queue q;
   public:
      Queue(){
        q.front=-1;
...
int Queue::isempty()
{
	return(q.front==q.rear) ?1:0;  //condition ? expression1 : expression2
}
int Queue::isfull()
{   
